...
export const ORDER_POST_REQUEST: 'ORDER/POST_REQUEST' = 'ORDER/POST_REQUEST';
export const ORDER_POST_SUCCESS: 'ORDER/POST_SUCCESS' = 'ORDER/POST_SUCCESS';
export const ORDER_POST_FAILED: 'ORDER/POST_FAILED' = 'ORDER/POST_FAILED';
export const ORDER_POST_EMPTY: 'ORDER/POST_EMPTY' = 'ORDER/POST_EMPTY';
export const ORDER_RESET_INFO: 'ORDER/RESET_INFO' = 'ORDER/RESET_INFO';
